...
fun SprintApp(
    ...
    // Injeção de Exercícios Didáticos Premium E2E no Catálogo Offline
    LaunchedEffect(Unit) {
        coroutineScope.launch(kotlinx.coroutines.Dispatchers.IO) {
            val db = com.strava_matematica.data.local.catalog.SprintCatalogDatabase.getInstance(context)
            val dao = db.exerciseDao()
            val countByTrig = dao.countByTemplate("rich_trig_diagram")
            if (countByTrig == 0) {
                val richExercises = listOf(
                    com.strava_matematica.data.local.catalog.ExerciseEntity(
                        id = "rich_trig_001",
                        statement = "Encontre o valor do cateto oposto x no triângulo retângulo.\n[fig:right_triangle,angle=30,hyp=10,opp=x]",
                        expectedAnswer = "5",
                        primarySkill = "trig_razoes",
                        skillTagsJson = "[\"trig_razoes\"]",
                        difficulty = 3.2,
                        estimatedTimeMs = 45000,
                        sourceLibrary = "rich_visual_v1",
                        sourceLicense = "CC-BY",
                        subject = "math",
                        canvasMode = "calculation",
                        validatorType = "exact",
                        validatorConfigJson = null,
                        nodeId = "trig_razoes_rich_1",
                        templateId = "rich_trig_diagram",
                        templateVersion = 1,
                        variantSeed = 1,
                        answerType = "numeric",
                        methodTagsJson = null,
                        prerequisiteTagsJson = null,
                        affinityTagsJson = null,
                        parameterVectorJson = null,
                        difficultyVectorJson = null
                    ),
                    com.strava_matematica.data.local.catalog.ExerciseEntity(
                        id = "rich_trig_002",
                        statement = "Determine o valor de y (cateto adjacente) no triângulo retângulo.\n[fig:right_triangle,angle=60,hyp=8,adj=y]",
                        expectedAnswer = "4",
                        primarySkill = "trig_razoes",
                        skillTagsJson = "[\"trig_razoes\"]",
                        difficulty = 3.5,
                    ...
                    com.strava_matematica.data.local.catalog.ExerciseEntity(
                        id = "rich_trig_003",
                        statement = "Calcule o cateto oposto h no triângulo retângulo.\n[fig:right_triangle,angle=45,hyp=10,opp=h]",
                        expectedAnswer = "7", // Aproximação inteira de 10*sen(45) = 7.07
                        primarySkill = "trig_razoes",
                        skillTagsJson = "[\"trig_razoes\"]",
                        difficulty = 3.8,
                        estimatedTimeMs = 45000,
                    ...
                    com.strava_matematica.data.local.catalog.ExerciseEntity(
                        id = "rich_prob_001",
                        statement = "No diagrama de Venn, qual a probabilidade de selecionar um aluno que joga APENAS Futebol?\n[fig:venn_2,labelA=Futebol,labelB=Volei,valA=13,valInter=5,valB=10,valOuter=2]",
                        expectedAnswer = "13/30",
                        primarySkill = "probabilidade",
                        skillTagsJson = "[\"probabilidade\"]",
                        difficulty = 3.6,
                        estimatedTimeMs = 45000,
                        sourceLibrary = "rich_visual_v1",
                        sourceLicense = "CC-BY",
                    ...
                    com.strava_matematica.data.local.catalog.ExerciseEntity(
                        id = "rich_prob_002",
                        statement = "No diagrama, qual a probabilidade de um aluno jogar ambos os esportes (Futebol e Vôlei)?\n[fig:venn_2,labelA=Futebol,labelB=Volei,valA=13,valInter=5,valB=10,valOuter=2]",
                        expectedAnswer = "5/30",
                        primarySkill = "probabilidade",
                        skillTagsJson = "[\"probabilidade\"]",
                        difficulty = 3.4,
                    ...
                    com.strava_matematica.data.local.catalog.ExerciseEntity(
                        id = "rich_log_001",
                        statement = "A figura exibe o gráfico da função f(x) = log_2(x). Determine o valor de k tal que f(k) = 2.\n[fig:cartesian_log,base=2,pointX=k,pointY=2]",
                        expectedAnswer = "4",
                        primarySkill = "funcao_logaritmica",
                        skillTagsJson = "[\"funcao_logaritmica\"]",
                        difficulty = 3.8,
                        estimatedTimeMs = 45000,
                        sourceLibrary = "rich_visual_v1",
                        sourceLicense = "CC-BY",
                        ...
                        validatorType = "exact",
                        validatorConfigJson = null,
                        nodeId = "funcao_logaritmica_rich_1",
                        templateId = "rich_trig_diagram",
                        templateVersion = 1,
                        variantSeed = 6,
                        answerType = "numeric",
                    ...
                    com.strava_matematica.data.local.catalog.ExerciseEntity(
                        id = "rich_log_002",
                        statement = "No gráfico de f(x) = log_2(x), determine k sabendo que a ordenada correspondente é 3.\n[fig:cartesian_log,base=2,pointX=k,pointY=3]",
                        expectedAnswer = "8",
                        primarySkill = "funcao_logaritmica",
                        skillTagsJson = "[\"funcao_logaritmica\"]",
                        difficulty = 4.0,
                        ...
                        validatorType = "exact",
                        validatorConfigJson = null,
                        nodeId = "funcao_logaritmica_rich_2",
                        templateId = "rich_trig_diagram",
                        templateVersion = 1,
                        variantSeed = 7,
                        answerType = "numeric",
                ...
                db.runInTransaction {
                    for (ex in richExercises) {
                        try {
                            db.openHelper.writableDatabase.execSQL(
                                "INSERT OR REPLACE INTO exercises (id, statement, expected_answer, primary_skill, skill_tags_json, difficulty, estimated_time_ms, source_library, source_license, subject, canvas_mode, validator_type, validator_config_json, node_id, template_id, template_version, variant_seed, answer_type, method_tags_json, prerequisite_tags_json, affinity_tags_json, parameter_vector_json, difficulty_vector_json) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                                arrayOf<Any?>(
                                    ex.id, ex.statement, ex.expectedAnswer, ex.primarySkill, ex.skillTagsJson,
                                    ex.difficulty, ex.estimatedTimeMs, ex.sourceLibrary, ex.sourceLicense,
                                    ex.subject, ex.canvasMode, ex.validatorType, ex.validatorConfigJson,
                                    ex.nodeId, ex.templateId, ex.templateVersion, ex.variantSeed,
                                    ex.answerType, ex.methodTagsJson, ex.prerequisiteTagsJson,
                                    ex.affinityTagsJson, ex.parameterVectorJson, ex.difficultyVectorJson
                                )
                            )
                        } catch (e: Exception) {
                            e.printStackTrace()
