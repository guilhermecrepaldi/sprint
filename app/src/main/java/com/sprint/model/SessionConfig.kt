...
enum class SessionStatus { GESTURE_ONBOARDING, CONFIG, CALIBRATION, DASHBOARD, ACTIVE, SUBMITTING, RESULT, SESSION_SUMMARY, FINISHED, DRILL, DRILL_RESULT, RANKING, ERROR }
