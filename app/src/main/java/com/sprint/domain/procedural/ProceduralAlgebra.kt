...
object ProceduralAlgebra {
    ...
    fun generate(skillTag: String, mmr: Int, random: Random = Random): ProceduralExercise {
        return when (skillTag) {
            ...
            "fatoracao_produtos_notaveis", "polinomios", "alg_elem", "alg_elem_poly" -> generatePolynomial(mmr, random, skillTag)
     ...
     */
    private fun generatePolynomial(mmr: Int, random: Random, skillTag: String): ProceduralExercise {
